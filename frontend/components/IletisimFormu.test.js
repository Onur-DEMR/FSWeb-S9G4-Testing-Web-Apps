...
test("form gönderildiğinde girilen tüm değerler render ediliyor.", async () => {
  ...
  userEvent.type(surname, "demir");
  userEvent.type(email, "ahmet@abc.com");
  ...
  expect(displayName).toHaveTextContent("ahmet");
  expect(displayLastName).toHaveTextContent("demir");
  expect(displayEmail).toHaveTextContent("ahmet@abc.com");
